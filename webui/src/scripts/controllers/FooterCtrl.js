app.controller('FooterCtrl', function($browser, $http, $scope, $rootScope, Restangular, $timeout, $sce, RequestCacheService, PortalSettingsService, $translatePartialLoader, $translate) {
