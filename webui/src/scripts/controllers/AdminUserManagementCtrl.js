...
//------------------------------------------------------
app.controller('AdminUsersCtrl', function($scope, PortalSettingsService, $rootScope, $timeout, $q, $translatePartialLoader, Restangular, RestFullResponse, FileUploadService, $translate) {
  ...
  $scope.addUserValidation = function() {
    var translation = $translate.instant(['tab_user_fname_message', 'tab_user_lname_message', 'tab_user_enter_email', 'tab_user_enter_validemail', 'tab_user_password_message', 'tab_user_confirm_password_message', 'tab_user_password_nomatch']);
    $('#add-user-form').form({
      first_name: {
  ...
  $scope.editUserValidation = function() {
    var translation = $translate.instant(['tab_user_fname_message', 'tab_user_lname_message', 'tab_user_enter_email', 'tab_user_enter_validemail', 'tab_user_password_nomatch']);
    $('#edit-user-form').form({
      first_name: {
        identifier: 'first_name',
        rules: [{
